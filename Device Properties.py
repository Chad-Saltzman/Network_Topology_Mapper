...
# #                 continue
# #             else:
# #                 self.deviceType = "Unidentifiable"  # Both layer2 and layer3 protocols appear for the device or no protocols appear
...
nx_graph.add_node(20, size=20, title='couple', group=2, shape = "image",image="Somefile.png")
nx_graph.add_node(21, size=15, title='couple', group=2, shape = "image", image = "Somefile.png")
