...
class Device:
    ...
    # def __repr__(self):
        ...
        # MacExport = self.MACAddress

        # IPExport = self.IPAddress 
    ...
    #     dataDictionary = self.Devices

    #     # dump data
    #     dataJSON = dumps(dataDictionary)
    #     return render(request, 'main / home.html', {'data': dataJSON})
